          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <div class="col">
              <div class="card shadow-sm" >
                <img src="{{ asset('images/productos/1/ampli-guitar.jpg') }}" alt="" width="254" height="200">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/2/guit-acus.jpeg') }}" alt="" width="254" height="200">
                <div class="card-body">
                  <h5 class="card-title">GUIT. ACUSTICA CONCERT NYLON CLASSICAL C/GIG BAG GODIN</h5>
                  <p class="card-text">$500.00 </p>
                  <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                      <a href="{{ route('detalleguitarra1') }}" class="botondetalles">Detalles</a>
                    </div>
                      <a href=" " class="botoncarrito">Agregar</a>
                  </div>
                </div>
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('/images/productos/3/50-Partituras-Para-Aficionados-Al-Piano.jpg') }}" alt="" width="254" height="249">
                <div class="card-body" >
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/4/yamaha-sbp2f5.jpg') }}" alt="" width="254" height="200">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/5/lpa1331-1-1030x1030.jpg') }}" alt="" width="254" height="225">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/6/jackson-js32rt-dinky-151963.jpg') }}" alt="" width="254" height="225">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/7/psre273.jpg') }}" alt="" width="254" height="200">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/8/yamaha-pss-a50-teclado-portatil.jpg') }}" alt="" width="254" height="200">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/9/xps-30_gal.jpg') }}" alt="" width="254" height="200">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/10/yas-62-1030x1030.jpg') }}" alt="" width="254" height="200">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/11/YTR2330YA-1030x1030.jpg') }}" alt="" width="254" height="200">
                <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm">
              <img src="{{ asset('images/productos/12/S082-3-4.jpg') }}" alt="" width="254" height="248">
                <div class="card-body">
